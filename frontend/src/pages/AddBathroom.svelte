...
async function handleSubmit(e) {
    ...
    let result = await fetch("http://0.0.0.0:3030/api/locations", { 
        method: "POST", 
...
<form on:submit|preventDefault={handleSubmit} method="POST" action="#" class="flex flex-col">
    ...
    <input class="block p-3 rounded border mb-2" name="score" type="number" placeholder="Score (out of 100)" max="100" min="0" required />
