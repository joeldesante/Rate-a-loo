...
const CREATE_RATING_TABLE = "CREATE TABLE IF NOT EXISTS ratings (rating INT NOT NULL, location INT NOT NULL, details TEXT NOT NULL, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP);";
